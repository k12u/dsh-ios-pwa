...
- **QR Code Generator**, Copyright (c) 2009 Kazuhiko Arase, MIT. `gateway/src/pairing/qrcode.cjs` is the upstream `js/dist/qrcode.js` retrieved 2026-09-05; only the filename changed. License: `gateway/src/pairing/LICENSE`. Source: https://github.com/kazuhikoarase/qrcode-generator
